return {
  ...
  {
    -- its almost perfect but it doesn't save between relogs
    "zion-off/mole.nvim",
    enabled = false,
    dependencies = { "MunifTanjim/nui.nvim" },
    opts = {
      keys = {
        annotate = "<leader>ha",      -- visual mode
        start_session = "<leader>hs", -- normal mode
        stop_session = "<leader>hq",  -- normal mode
        toggle_window = "<leader>hl", -- normal mode
      },
    },
  }
}
